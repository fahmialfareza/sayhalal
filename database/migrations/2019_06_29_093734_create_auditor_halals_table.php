...
class CreateAuditorHalalsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('auditor_halal', function (Blueprint $table) {
            ...
            $table->bigInteger('lph_id')->unsigned()->references('id')->on('lph');
            // Auditor
            $table->string('nama');
            // Alamat Auditor
    ...
    {
        Schema::dropIfExists('auditor_halal');
    }
}
