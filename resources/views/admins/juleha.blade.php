        ...
        <div class="but_list">
          <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
            <ul id="myTab" class="nav nav-tabs" role="tablist">
              <li role="presentation" class="active"><a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">Data Juru Sembelih Halal (Juleha)</a></li>
            ...
            <!-- <div id="myTabContent" class="tab-content">
              ...
              <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
                <div class="col-md-12 graphs">
                  <div class="xs">
                    <h3>Data Juru Sembelih Halal (Juleha)</h3>
                        ...
                        <table class="table">
                          ...
                          <tbody>
                            <?php
                              $l = 1;
                            ?>
                            @foreach ($juleha as $jul)
                              <tr>
                                <th scope="row">{{$l}}</th>
                                <td>{{$jul->nama}}</td>
                                <td>{{$jul->alamat_lengkap}}</td>
                                <td>{{$jul->nomor_handphone}}</td>
                              </tr>
                            @endforeach
                          </tbody>
                        </table>
