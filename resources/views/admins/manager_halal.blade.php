        ...
        <div class="but_list">
          <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
            <ul id="myTab" class="nav nav-tabs" role="tablist">
              <li role="presentation" class="active"><a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">Data Manager Halal</a></li>
                        ...
                        <table class="table">
                          ...
                          <tbody>
                            <?php
                              $l = 1;
                            ?>
                            @foreach ($manager_halal as $manager)
                              <tr>
                                <th scope="row">{{$l}}</th>
                                <td>{{$manager->nama}}</td>
                                <td>{{$manager->alamat_lengkap}}</td>
                                <td>{{$manager->nomor_handphone}}</td>
                              </tr>
                            @endforeach
                          </tbody>
                        </table>
