...
<head>
  <title>Say Halal | Juru Sembelih Halal (Juleha)</title>
  ...
  <div id="wrapper">
    ...
    <div id="page-wrapper">
      <div class="grid_3 grid_5">
        <h3>Juru Sembelih Halal (Juleha)</h3>
        <div class="but_list">
          <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
            <ul id="myTab" class="nav nav-tabs" role="tablist">
              ...
              @else
                ...
                <li role="presentation"><a href="#edit" role="tab" id="edit-tab" data-toggle="tab" aria-controls="edit">Edit Data Juleha</a></li>
              @endif
            </ul>
            <div id="myTabContent" class="tab-content">
              ...
              <div role="tabpanel" class="tab-pane fade in active" id="daftar" aria-labelledby="daftar-tab">
                <div class="graphs">
                  <div class="xs">
                    <h3>Form Pendaftaran Calon Juru Sembelih Halal (Juleha)</h3>
                    <div class="tab-content">
                      <div class="tab-pane active" id="horizontal-form">
                        @if (Auth::user()->juleha == null)
                          <form class="form-horizontal" enctype="multipart/form-data" method="POST" action="{{route('users.juleha_store')}}">
                            @csrf
                        ...
                        @else
                          <form class="form-horizontal">
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Nama *</label>
                              <div class="col-sm-8">
                                <input disabled type="text" class="form-control1" id="nama" name="nama" value="{{Auth::user()->juleha->nama}}" placeholder="Nama Lembaga" autofocus required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="txtarea1" class="col-sm-2 control-label">Alamat Lengkap *</label>
                              <div class="col-sm-8"><textarea disabled name="alamat_lengkap" id="alamat_lengkap" cols="50" rows="4" placeholder="Alamat Lengkap" class="form-control1" required>{{ Auth::user()->juleha->alamat_lengkap }}</textarea></div>
                            </div>
                            <div class="form-group">
                              <label for="txtarea1" class="col-sm-2 control-label">Provinsi *</label>
                              <div class="col-sm-8">
                                <input disabled type="text" class="form-control1" id="provinsi_id" name="provinsi_id" value="{{ App\Province::where('id', Auth::user()->juleha->provinsi_id)->first()->name }}" placeholder="Provinsi" required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="txtarea1" class="col-sm-2 control-label">Kota/Kabupaten *</label>
                              <div class="col-sm-8">
                                <input disabled type="text" class="form-control1" id="kota_kabupaten_id" name="kota_kabupaten_id" value="{{ App\Regency::where('id', Auth::user()->juleha->kota_kabupaten_id)->first()->name }}" placeholder="Kota/Kabupaten" required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="txtarea1" class="col-sm-2 control-label">Tempat Lahir *</label>
                            ...
                            <div class="form-group">
                              <label for="txtarea1" class="col-sm-3 control-label">Provinsi *</label>
                              <div class="col-sm-7">
                                <input disabled type="text" class="form-control1" id="provinsi_tl" name="provinsi_tl_id" value="{{ App\Province::where('id', Auth::user()->juleha->provinsi_tl_id)->first()->name }}" placeholder="Provinsi" required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="txtarea1" class="col-sm-3 control-label">Kota/Kabupaten *</label>
                              <div class="col-sm-7">
                                <input disabled type="text" class="form-control1" id="kota_kabupaten_tl" name="kota_kabupaten_tl_id" value="{{ App\Regency::where('id', Auth::user()->juleha->kota_kabupaten_tl_id)->first()->name }}" placeholder="Kota/Kabupaten" required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Nomor Handphone/Telepon Lembaga *</label>
                              <div class="col-sm-8">
                                <input disabled type="number" class="form-control1" id="nomor_handphone" name="nomor_handphone" value="{{Auth::user()->juleha->nomor_handphone}}" placeholder="Nomor Handphone/Telepon Lembaga" required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Email *</label>
                              <div class="col-sm-8">
                                <input disabled type="email" class="form-control1" id="email" name="email" value="{{Auth::user()->juleha->email}}" placeholder="Email" required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Sosial Media *</label>
                              <div class="col-sm-8">
                                <input disabled type="email" class="form-control1" id="sosmed" name="sosmed" value="{{Auth::user()->juleha->sosmed}}" placeholder="Sosmed" required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Pendidikan Terakhir *</label>
                              <div class="col-sm-8">
                                <input disabled type="email" class="form-control1" id="pendidikan_terakhir" name="pendidikan_terakhir" value="{{Auth::user()->juleha->pendidikan_terakhir}}" placeholder="Pendidikan Terakhir" required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Foto</label>
                              <div class="col-sm-8">
                                <img class="img-responsive" src="/images/juleha/{{Auth::user()->id}}/{{Auth::user()->juleha->foto}}" alt="">
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">KTP</label>
                              <div class="col-sm-8">
                                <img class="img-responsive" src="/images/juleha/{{Auth::user()->id}}/{{Auth::user()->juleha->ktp}}" alt="">
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Ijazah</label>
                              <div class="col-sm-8">
                                <img class="img-responsive" src="/images/juleha/{{Auth::user()->id}}/{{Auth::user()->juleha->ijazah}}" alt="">
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Transkrip</label>
                              <div class="col-sm-8">
                                <img class="img-responsive" src="/images/juleha/{{Auth::user()->id}}/{{Auth::user()->juleha->transkip}}" alt="">
                              </div>
                            </div>
                          </form>
                        @endif
                ...
                <div class="graphs">
                  <div class="xs">
                    ...
                    <div class="tab-content">
                      <div class="tab-pane active" id="horizontal-form">
                        @if (Auth::user()->juleha != null)
                          <form class="form-horizontal" enctype="multipart/form-data" method="POST" action="{{route('users.juleha_update', Auth::user()->juleha->id)}}">
                            @csrf
                            <input type="hidden" name="_method" value="PUT">
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Nama *</label>
                              <div class="col-sm-8">
                                <input type="text" class="form-control1" id="nama" name="nama" value="{{old('nama', Auth::user()->juleha->nama)}}" placeholder="Nama" required>
                              </div>
                              <div class="col-sm-2">
                                @error('nama')
                                  <p class="help-block"><strong>{{ $message }}</strong></p>
                            ...
                            <div class="form-group">
                              <label for="txtarea1" class="col-sm-2 control-label">Alamat Lengkap *</label>
                              <div class="col-sm-8"><textarea name="alamat_lengkap" id="alamat_lengkap" cols="50" rows="4" placeholder="Alamat Lengkap" class="form-control1" required>{{old('alamat_lengkap', Auth::user()->juleha->alamat_lengkap)}}</textarea></div>
                              <div class="col-sm-2">
                                @error('alamat_lengkap')
                                  <p class="help-block"><strong>{{ $message }}</strong></p>
                                @enderror
                            ...
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Tanggal Lahir *</label>
                              <div class="col-sm-8">
                                <input type="date" class="form-control1" id="tanggal_lahir" name="tanggal_lahir" value="{{old('tanggal_lahir', Auth::user()->juleha->tanggal_lahir)}}" placeholder="Nama Narahubung" required>
                              </div>
                              <div class="col-sm-2">
                                @error('tanggal_lahir')
                                  <p class="help-block"><strong>{{ $message }}</strong></p>
                            ...
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Nomor Handphone/Telepon *</label>
                              <div class="col-sm-8">
                                <input type="number" class="form-control1" id="nomor_handphone" name="nomor_handphone" value="{{old('nomor_handphone', Auth::user()->juleha->nomor_handphone)}}" placeholder="Nomor Handphone/Telepon Lembaga" required>
                              </div>
                              <div class="col-sm-2">
                                @error('nomor_handphone')
                                  <p class="help-block"><strong>{{ $message }}</strong></p>
                            ...
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Email *</label>
                              <div class="col-sm-8">
                                <input type="email" class="form-control1" id="email" name="email" value="{{old('email', Auth::user()->juleha->email)}}" placeholder="Email" required>
                              </div>
                              <div class="col-sm-2">
                                @error('email')
                                  <p class="help-block"><strong>{{ $message }}</strong></p>
                            ...
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Sosial Media *</label>
                              <div class="col-sm-8">
                                <input type="text" class="form-control1" id="sosmed" name="sosmed" value="{{old('sosmed', Auth::user()->juleha->sosmed)}}" placeholder="Contoh: FB: ..., IG: ...." required>
                              </div>
                              <div class="col-sm-2">
                                @error('sosmed')
                                  <p class="help-block"><strong>{{ $message }}</strong></p>
                            ...
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Pendidikan Terakhir *</label>
                              <div class="col-sm-8">
                                <input type="text" class="form-control1" id="pendidikan_terakhir" name="pendidikan_terakhir" value="{{old('pendidikan_terakhir', Auth::user()->juleha->pendidikan_terakhir)}}" placeholder="Contoh: SMA" required>
                              </div>
                              <div class="col-sm-2">
                                @error('pendidikan_terakhir')
                                  <p class="help-block"><strong>{{ $message }}</strong></p>
