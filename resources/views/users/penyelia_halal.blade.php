        ...
        <div class="but_list">
          <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
            <ul id="myTab" class="nav nav-tabs" role="tablist">
              ...
              @if (Auth::user()->penyelia_halal == null)
              ...
              @else
                ...
                <li role="presentation"><a href="#edit" role="tab" id="edit-tab" data-toggle="tab" aria-controls="edit">Edit Data Penyelia</a></li>
              @endif
            </ul>
            <div id="myTabContent" class="tab-content">
              ...
              <div role="tabpanel" class="tab-pane fade" id="daftar" aria-labelledby="daftar-tab">
                <div class="graphs">
                  <div class="xs">
                    <h3>Form Pendaftaran Calon Penyelia Halal</h3>
                    <div class="tab-content">
                      <div class="tab-pane active" id="horizontal-form">
                        @if (Auth::user()->penyelia_halal == null)
                          <form class="form-horizontal" enctype="multipart/form-data" method="POST" action="{{route('users.penyelia_halal_store')}}">
                            @csrf
                            <div class="form-group">
                              <label for="txtarea1" class="col-sm-2 control-label">Halal Center *</label>
                              <div class="col-sm-8">
                                <select class="form-control1" name="halal_center_id" id="halal_center_id" autofocus required>
                                  <option value="0">Belum Punya Halal Center</option>
                                  <?php foreach ($halal_center as $halal): ?>
                                    <option value="{{$halal->id}}">{{$halal->nama_lembaga}}</option>
                                  <?php endforeach; ?>
                                </select>
                              </div>
                              <div class="col-sm-2">
                                @error('halal_center_id')
                        ...
                        @else
                          <form class="form-horizontal">
                            @if (Auth::user()->penyelia_halal->halal_center_id == 0)
                              <div class="form-group">
                                <label for="focusedinput" class="col-sm-2 control-label">Halal Center *</label>
                                <div class="col-sm-8">
                                  <input disabled type="text" class="form-control1" id="halal_center" name="halal_center" value="Belum Punya Halal Center" placeholder="Nama Lembaga" autofocus required>
                                </div>
                              </div>
                            @else
                              <div class="form-group">
                                <label for="focusedinput" class="col-sm-2 control-label">Halal Center *</label>
                                <div class="col-sm-8">
                                  <input disabled type="text" class="form-control1" id="halal_center" name="halal_center" value="{{Auth::user()->penyelia_halal->halal_center->nama_lembaga}}" placeholder="Nama Lembaga" autofocus required>
                                </div>
                              </div>
                            @endif
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Nama *</label>
                              <div class="col-sm-8">
                                <input disabled type="text" class="form-control1" id="nama" name="nama" value="{{Auth::user()->penyelia_halal->nama}}" placeholder="Nama Lembaga" autofocus required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="txtarea1" class="col-sm-2 control-label">Alamat Lengkap *</label>
                              <div class="col-sm-8"><textarea disabled name="alamat_lengkap" id="alamat_lengkap" cols="50" rows="4" placeholder="Alamat Lengkap" class="form-control1" required>{{ Auth::user()->penyelia_halal->alamat_lengkap }}</textarea></div>
                            </div>
                            <div class="form-group">
                              <label for="txtarea1" class="col-sm-2 control-label">Provinsi *</label>
                              <div class="col-sm-8">
                                <input disabled type="text" class="form-control1" id="provinsi_id" name="provinsi_id" value="{{ App\Province::where('id', Auth::user()->penyelia_halal->provinsi_id)->first()->name }}" placeholder="Provinsi" required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="txtarea1" class="col-sm-2 control-label">Kota/Kabupaten *</label>
                              <div class="col-sm-8">
                                <input disabled type="text" class="form-control1" id="kota_kabupaten_id" name="kota_kabupaten_id" value="{{ App\Regency::where('id', Auth::user()->penyelia_halal->kota_kabupaten_id)->first()->name }}" placeholder="Kota/Kabupaten" required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="txtarea1" class="col-sm-2 control-label">Tempat Lahir *</label>
                            ...
                            <div class="form-group">
                              <label for="txtarea1" class="col-sm-3 control-label">Provinsi *</label>
                              <div class="col-sm-7">
                                <input disabled type="text" class="form-control1" id="provinsi_tl" name="provinsi_tl_id" value="{{ App\Province::where('id', Auth::user()->penyelia_halal->provinsi_tl_id)->first()->name }}" placeholder="Provinsi" required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="txtarea1" class="col-sm-3 control-label">Kota/Kabupaten *</label>
                              <div class="col-sm-7">
                                <input disabled type="text" class="form-control1" id="kota_kabupaten_tl" name="kota_kabupaten_tl_id" value="{{ App\Regency::where('id', Auth::user()->penyelia_halal->kota_kabupaten_tl_id)->first()->name }}" placeholder="Kota/Kabupaten" required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Nomor Handphone/Telepon Lembaga *</label>
                              <div class="col-sm-8">
                                <input disabled type="number" class="form-control1" id="nomor_handphone" name="nomor_handphone" value="{{Auth::user()->penyelia_halal->nomor_handphone}}" placeholder="Nomor Handphone/Telepon Lembaga" required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Email *</label>
                              <div class="col-sm-8">
                                <input disabled type="email" class="form-control1" id="email" name="email" value="{{Auth::user()->penyelia_halal->email}}" placeholder="Email" required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Sosial Media *</label>
                              <div class="col-sm-8">
                                <input disabled type="email" class="form-control1" id="sosmed" name="sosmed" value="{{Auth::user()->penyelia_halal->sosmed}}" placeholder="Sosmed" required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Pendidikan Terakhir *</label>
                              <div class="col-sm-8">
                                <input disabled type="email" class="form-control1" id="pendidikan_terakhir" name="pendidikan_terakhir" value="{{Auth::user()->penyelia_halal->pendidikan_terakhir}}" placeholder="Pendidikan Terakhir" required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Foto</label>
                              <div class="col-sm-8">
                                <img class="img-responsive" src="/images/penyelia_halal/{{Auth::user()->id}}/{{Auth::user()->penyelia_halal->foto}}" alt="">
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">KTP</label>
                              <div class="col-sm-8">
                                <img class="img-responsive" src="/images/penyelia_halal/{{Auth::user()->id}}/{{Auth::user()->penyelia_halal->ktp}}" alt="">
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Ijazah</label>
                              <div class="col-sm-8">
                                <img class="img-responsive" src="/images/penyelia_halal/{{Auth::user()->id}}/{{Auth::user()->penyelia_halal->ijazah}}" alt="">
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Transkrip</label>
                              <div class="col-sm-8">
                                <img class="img-responsive" src="/images/penyelia_halal/{{Auth::user()->id}}/{{Auth::user()->penyelia_halal->transkip}}" alt="">
                              </div>
                            </div>
                          </form>
                        @endif
              ...
              <div role="tabpanel" class="tab-pane fade" id="edit" aria-labelledby="edit-tab">
                <div class="graphs">
                  <div class="xs">
                    <h3>Edit Data Penyelia Halal</h3>
                    <div class="tab-content">
                      <div class="tab-pane active" id="horizontal-form">
                        @if (Auth::user()->penyelia_halal != null)
                          <form class="form-horizontal" enctype="multipart/form-data" method="POST" action="{{route('users.penyelia_halal_update', Auth::user()->penyelia_halal->id)}}">
                            @csrf
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                <select class="form-control1" name="halal_center_id" id="halal_center_id" autofocus required>
                                  <option value="0">Belum Punya Halal Center</option>
                                  <?php foreach ($halal_center as $halal): ?>
                                    <option @if ($halal->id == Auth::user()->penyelia_halal->halal_center_id) selected @endif value="{{$halal->id}}">{{$halal->nama_lembaga}}</option>
                                  <?php endforeach; ?>
                                </select>
                              </div>
                              <div class="col-sm-2">
                            ...
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Nama *</label>
                              <div class="col-sm-8">
                                <input type="text" class="form-control1" id="nama" name="nama" value="{{old('nama', Auth::user()->penyelia_halal->nama)}}" placeholder="Nama" required>
                              </div>
                              <div class="col-sm-2">
                                @error('nama')
                                  <p class="help-block"><strong>{{ $message }}</strong></p>
                            ...
                            <div class="form-group">
                              <label for="txtarea1" class="col-sm-2 control-label">Alamat Lengkap *</label>
                              <div class="col-sm-8"><textarea name="alamat_lengkap" id="alamat_lengkap" cols="50" rows="4" placeholder="Alamat Lengkap" class="form-control1" required>{{old('alamat_lengkap', Auth::user()->penyelia_halal->alamat_lengkap)}}</textarea></div>
                              <div class="col-sm-2">
                                @error('alamat_lengkap')
                                  <p class="help-block"><strong>{{ $message }}</strong></p>
                                @enderror
                            ...
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Tanggal Lahir *</label>
                              <div class="col-sm-8">
                                <input type="date" class="form-control1" id="tanggal_lahir" name="tanggal_lahir" value="{{old('tanggal_lahir', Auth::user()->penyelia_halal->tanggal_lahir)}}" placeholder="Nama Narahubung" required>
                              </div>
                              <div class="col-sm-2">
                                @error('tanggal_lahir')
                                  <p class="help-block"><strong>{{ $message }}</strong></p>
                            ...
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Nomor Handphone/Telepon *</label>
                              <div class="col-sm-8">
                                <input type="number" class="form-control1" id="nomor_handphone" name="nomor_handphone" value="{{old('nomor_handphone', Auth::user()->penyelia_halal->nomor_handphone)}}" placeholder="Nomor Handphone/Telepon Lembaga" required>
                              </div>
                              <div class="col-sm-2">
                                @error('nomor_handphone')
                                  <p class="help-block"><strong>{{ $message }}</strong></p>
                            ...
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Email *</label>
                              <div class="col-sm-8">
                                <input type="email" class="form-control1" id="email" name="email" value="{{old('email', Auth::user()->penyelia_halal->email)}}" placeholder="Email" required>
                              </div>
                              <div class="col-sm-2">
                                @error('email')
                                  <p class="help-block"><strong>{{ $message }}</strong></p>
                            ...
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Sosial Media *</label>
                              <div class="col-sm-8">
                                <input type="text" class="form-control1" id="sosmed" name="sosmed" value="{{old('sosmed', Auth::user()->penyelia_halal->sosmed)}}" placeholder="Contoh: FB: ..., IG: ...." required>
                              </div>
                              <div class="col-sm-2">
                                @error('sosmed')
                                  <p class="help-block"><strong>{{ $message }}</strong></p>
                            ...
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Pendidikan Terakhir *</label>
                              <div class="col-sm-8">
                                <input type="text" class="form-control1" id="pendidikan_terakhir" name="pendidikan_terakhir" value="{{old('pendidikan_terakhir', Auth::user()->penyelia_halal->pendidikan_terakhir)}}" placeholder="Contoh: SMA" required>
                              </div>
                              <div class="col-sm-2">
                                @error('pendidikan_terakhir')
                                  <p class="help-block"><strong>{{ $message }}</strong></p>
