          ...
          <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
            <ul id="myTab" class="nav nav-tabs" role="tablist">
              ...
              @else
                ...
                <li role="presentation"><a href="#datalph" role="tab" id="data-tab" data-toggle="tab" aria-controls="datalph">Data Calon Auditor Halal</a></li>
              @endif
            </ul>
            <div id="myTabContent" class="tab-content">
                      ...
                      <div class="table-responsive">
                        <table class="table">
                          ...
                          <tbody>
                            ...
                            ?>
                            @if (Auth::user()->lph != null)
                              @if (Auth::user()->lph->auditor_halal != null)
                                @foreach (Auth::user()->lph->auditor_halal as $auditor_halal)
                                  <tr>
                                    <th scope="row">{{$au}}</th>
                                    <td>{{$auditor_halal->nama}}</td>
                                    <td>{{$auditor_halal->alamat_lengkap}}</td>
                                    <td>{{$auditor_halal->nomor_handphone}}</td>
                                  </tr>
                                @endforeach
                              @endif
                            @endif
              ...
              <div role="tabpanel" class="tab-pane fade" id="daftar" aria-labelledby="daftar-tab">
                <div class="graphs">
                  <div class="xs">
                    <h3>Form Pendaftaran Calon LPH (Lembaga Pemeriksa Halal)</h3>
                    <div class="tab-content">
                      <div class="tab-pane active" id="horizontal-form">
                        @if (Auth::user()->lph == null)
                          <form class="form-horizontal" enctype="multipart/form-data" method="POST" action="{{route('users.lph_store')}}">
                            @csrf
                            ...
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Logo Lembaga</label>
                              <div class="col-sm-8">
                                <input type="file" class="form-control1" id="logo" name="logo" accept=".jpg,.jpeg,.png,.pdf">
                                <p class="help-block">Maksimal Scan/Foto KTP 1 MB.</p>
                              </div>
                              <div class="col-sm-2">
                                @error('logo')
                        ...
                        @else
                          <form class="form-horizontal">
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Nama Lembaga *</label>
                              <div class="col-sm-8">
                                <input disabled type="text" class="form-control1" id="nama_lembaga" name="nama_lembaga" value="{{Auth::user()->lph->nama_lembaga}}" placeholder="Nama Lembaga" autofocus required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="txtarea1" class="col-sm-2 control-label">Alamat Lengkap Lembaga *</label>
                              <div class="col-sm-8"><textarea disabled name="alamat_lengkap" id="alamat_lengkap" cols="50" rows="4" placeholder="Alamat Lengkap" class="form-control1" required>{{ Auth::user()->lph->alamat_lengkap }}</textarea></div>
                            </div>
                            <div class="form-group">
                              <label for="txtarea1" class="col-sm-2 control-label">Provinsi *</label>
                              <div class="col-sm-8">
                                <input disabled type="text" class="form-control1" id="provinsi_id" name="provinsi_id" value="{{ App\Province::where('id', Auth::user()->lph->provinsi_id)->first()->name }}" placeholder="Provinsi" required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="txtarea1" class="col-sm-2 control-label">Kota/Kabupaten *</label>
                              <div class="col-sm-8">
                                <input disabled type="text" class="form-control1" id="kota_kabupaten_id" name="kota_kabupaten_id" value="{{ App\Regency::where('id', Auth::user()->lph->kota_kabupaten_id)->first()->name }}" placeholder="Kota/Kabupaten" required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Nomor Handphone/Telepon Lembaga *</label>
                              <div class="col-sm-8">
                                <input disabled type="number" class="form-control1" id="nomor_handphone" name="nomor_handphone" value="{{Auth::user()->lph->nomor_handphone}}" placeholder="Nomor Handphone/Telepon Lembaga" required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Email Lembaga *</label>
                              <div class="col-sm-8">
                                <input disabled type="email" class="form-control1" id="email" name="email" value="{{Auth::user()->lph->email}}" placeholder="Email" required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Nama Narahubung *</label>
                              <div class="col-sm-8">
                                <input disabled type="text" class="form-control1" id="nama_narahubung" name="nama_narahubung" value="{{Auth::user()->lph->nama_narahubung}}" placeholder="Nama Narahubung" required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Nomor Handphone Narahubung *</label>
                              <div class="col-sm-8">
                                <input disabled type="number" class="form-control1" id="cp_narahubung" name="cp_narahubung" value="{{Auth::user()->lph->cp_narahubung}}" placeholder="Nomor Handphone Narahubung" required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">KTP Narahubung *</label>
                              <div class="col-sm-8">
                                <img class="img-responsive" src="/images/lph/{{Auth::user()->id}}/{{Auth::user()->lph->ktp_narahubung}}" alt="">
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Logo Lembaga (opsional)</label>
                              <div class="col-sm-8">
                                <img class="img-responsive" src="/images/lph/{{Auth::user()->id}}/{{Auth::user()->lph->logo}}" alt="">
                              </div>
                            </div>
                          </form>
                        @endif
              ...
              <div role="tabpanel" class="tab-pane fade" id="edit" aria-labelledby="edit-tab">
                <div class="graphs">
                  <div class="xs">
                    <h3>Edit Data LPH (Lembaga Pemeriksa Halal)</h3>
                    <div class="tab-content">
                      <div class="tab-pane active" id="horizontal-form">
                        @if (Auth::user()->lph != null)
                          <form class="form-horizontal" enctype="multipart/form-data" method="POST" action="{{route('users.lph_update', Auth::user()->lph->id)}}">
                            @csrf
                            <input name="_method" type="hidden" value="PUT">
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Nama Lembaga *</label>
                              <div class="col-sm-8">
                                <input type="text" class="form-control1" id="nama_lembaga" name="nama_lembaga" value="{{old('nama_lembaga', Auth::user()->lph->nama_lembaga)}}" placeholder="Nama Lembaga" autofocus required>
                              </div>
                              <div class="col-sm-2">
                                @error('nama_lembaga')
                                  <p class="help-block"><strong>{{ $message }}</strong></p>
                            ...
                            <div class="form-group">
                              <label for="txtarea1" class="col-sm-2 control-label">Alamat Lengkap Lembaga *</label>
                              <div class="col-sm-8"><textarea name="alamat_lengkap" id="alamat_lengkap" cols="50" rows="4" placeholder="Alamat Lengkap" class="form-control1" required>{{old('alamat_lengkap', Auth::user()->lph->alamat_lengkap)}}</textarea></div>
                              <div class="col-sm-2">
                                @error('alamat_lengkap')
                                  <p class="help-block"><strong>{{ $message }}</strong></p>
                                @enderror
                            ...
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Nomor Handphone/Telepon Lembaga *</label>
                              <div class="col-sm-8">
                                <input type="number" class="form-control1" id="nomor_handphone" name="nomor_handphone" value="{{old('nomor_handphone', Auth::user()->lph->nomor_handphone)}}" placeholder="Nomor Handphone/Telepon Lembaga" required>
                              </div>
                              <div class="col-sm-2">
                                @error('nomor_handphone')
                                  <p class="help-block"><strong>{{ $message }}</strong></p>
                            ...
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Email Lembaga *</label>
                              <div class="col-sm-8">
                                <input type="email" class="form-control1" id="email" name="email" value="{{old('email', Auth::user()->lph->email)}}" placeholder="Email" required>
                              </div>
                              <div class="col-sm-2">
                                @error('email')
                                  <p class="help-block"><strong>{{ $message }}</strong></p>
                            ...
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Nama Narahubung *</label>
                              <div class="col-sm-8">
                                <input type="text" class="form-control1" id="nama_narahubung" name="nama_narahubung" value="{{old('nama_narahubung', Auth::user()->lph->nama_narahubung)}}" placeholder="Nama Narahubung" required>
                              </div>
                              <div class="col-sm-2">
                                @error('nama_narahubung')
                                  <p class="help-block"><strong>{{ $message }}</strong></p>
                            ...
                            <div class="form-group">
                              <label for="focusedinput" class="col-sm-2 control-label">Nomor Handphone Narahubung *</label>
                              <div class="col-sm-8">
                                <input type="number" class="form-control1" id="cp_narahubung" name="cp_narahubung" value="{{old('cp_narahubung', Auth::user()->lph->cp_narahubung)}}" placeholder="Nomor Handphone Narahubung" required>
                              </div>
                              <div class="col-sm-2">
                                @error('cp_narahubung')
                                  <p class="help-block"><strong>{{ $message }}</strong></p>
